'''
This file implements the Heap data structure as a subclass of the
BinaryTree. The book implements Heaps using an *implicit* tree with
an *explicit* vector implementation, so the code in the book is
likely to be less helpful than the code for the other data structures.
...
class Heap(BinaryTree):
    ...
    def _is_heap_satisfied(node):
        '''
        Helper function for is_heap_satisfied
        '''
        ret = True
        if node.left:
